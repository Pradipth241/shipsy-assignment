  ...
  return (
    <Layout>
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-slate-600">Enter a Shipment ID to see its full details and history.</p>
      </div>
      ...
      {shipment && (
        <div className="bg-white p-6 rounded-lg shadow-sm space-y-6">
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-xl font-semibold text-slate-800">Shipment Information</h2>
              <p className="text-sm text-slate-500">ID: {shipment.id}</p>
            </div>
